...
Authors: "Lynn Wu, Haru Koga, Miaojun Pang"
output:
...
par(mfrow=c(1,6))
  ACF_Plot1 <- Acf(electricity_consumption_R$Primary.Energy, lag = 30, plot = TRUE,main="Residential ACF",ylim=c(-0.2,0.8))
  PACF_Plot1 <- Pacf(electricity_consumption_R$Primary.Energy, lag = 30, plot = TRUE,main="Residential PACF",ylim=c(-0.2,0.8))
  ACF_Plot2 <- Acf(electricity_consumption_C$Primary.Energy, lag = 30, plot = TRUE,main="Commercial ACF",ylim=c(-0.2,0.8))
  PACF_Plot2 <- Pacf(electricity_consumption_C$Primary.Energy, lag = 30, plot = TRUE,main="Commercial PACF",ylim=c(-0.2,0.8))
  ACF_Plot3 <- Acf(electricity_consumption_I$Primary.Energy, lag = 30, plot = TRUE,main="Industrial ACF",ylim=c(-0.2,0.8))
  PACF_Plot3 <- Pacf(electricity_consumption_I$Primary.Energy, lag = 30, plot = TRUE,main="Industrial PACF",ylim=c(-0.2,0.8))
...
par(mfrow=c(1,6))
  ACF_Plot4 <- Acf(electricity_consumption_R$Energy.Losses, lag = 30, plot = TRUE,main="Residential ACF",ylim=c(-0.2,0.8))
  PACF_Plot4 <- Pacf(electricity_consumption_R$Energy.Losses, lag = 30, plot = TRUE,main="Residential PACF",ylim=c(-0.2,0.8))
  ACF_Plot5 <- Acf(electricity_consumption_C$Energy.Losses, lag = 30, plot = TRUE,main="Commercial ACF",ylim=c(-0.2,0.8))
  PACF_Plot5 <- Pacf(electricity_consumption_C$Energy.Losses, lag = 30, plot = TRUE,main="Commercial PACF",ylim=c(-0.2,0.8))
  ACF_Plot6 <- Acf(electricity_consumption_I$Energy.Losses, lag = 30, plot = TRUE,main="Industrial ACF",ylim=c(-0.2,0.8))
  PACF_Plot6 <- Pacf(electricity_consumption_I$Energy.Losses, lag = 30, plot = TRUE,main="Industrial PACF",ylim=c(-0.2,0.8))
```
